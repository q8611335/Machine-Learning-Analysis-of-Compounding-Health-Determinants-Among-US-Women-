...
for hidden_layers in hidden_layer_candidates:
    ...
    print(f"  hidden_layer_sizes={str(hidden_layers):<15} → val balanced_accuracy = {val_score:.4f}")

    if val_score > best_val_score:
        best_val_score = val_score
        best_hidden_layers = hidden_layers

print(f"\nBest hidden_layer_sizes: {best_hidden_layers}  (val balanced_accuracy = {best_val_score:.4f})")
